...
class LiveView(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # --- Title ---
        ttk.Label(self, text="Live display", font=("Segoe UI", 11, "bold"),
                  style="PageTitle.TLabel").pack(anchor="w", pady=(0, 4))
        ttk.Label(self,
                  text="Your camera. A floating image. Ready to share.",
                  style="PageSubtitle.TLabel").pack(anchor="w", pady=(0, 10))
        ...
        self.idx_combo = ttk.Combobox(idx_row, state="readonly", width=14,
        ...
        ttk.Button(idx_row, text="Rescan",
                   command=self._rescan_indices).grid(row=2, column=1, padx=6)
        ttk.Label(idx_row, text="Backend:").grid(row=1, column=0, padx=(12, 6))
        self.backend_combo = ttk.Combobox(
            idx_row, state="readonly",
            values=[label for (label, _) in BACKENDS], width=14)
        ...
        ttk.Button(name_row, text="Find cameras",
                   command=self._list_names_ffmpeg).grid(row=0, column=1, padx=6)
        ...
        ttk.Button(name_row, text="Use Selected",
                   command=self._use_selected_name).grid(row=2, column=1, padx=6, pady=(6, 0))
        ...
        ttk.Label(settings, text="FPS:").grid(row=1, column=0,
        ...
        ttk.Label(views_row, text="Faces:").pack(anchor="w", padx=(0, 6))
        ...
        self.btn_preview = ttk.Button(actions, text="Start camera", style="Primary.TButton",
        ...
        self.btn_fullscreen = ttk.Button(actions, text="Show on TV", style="TV.TButton",
